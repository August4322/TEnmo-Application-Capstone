...
public class TransferController {
    ...
    public List<Transfer> getAllTransfers(Principal user) {
        ...
        int userAccountId = accountDao.findAccountById(userId).getAccountId();
        return transferDao.getAllTransfers(userAccountId);
    }

    //Get specific transfer via Id
    @RequestMapping(value = "account/transfer/{id}", method = RequestMethod.GET)
    public Transfer getTransferId(@PathVariable("id") int transferId) {
